...
import IndiaGoldRejectPage from "./RejectPage";
import IndiaGoldSuccessPage from "./IndiaGoldSuccessPage";

// Import jewelry icons
import banglesIcon from "./NewJwellaryImages/bracelet.png";
import mangalsutraIcon from "./NewJwellaryImages/mangalsutra.png";
import earringIcon from "./NewJwellaryImages/earrings.png";
import necklaceIcon from "./NewJwellaryImages/necklace.png";
import coinIcon from "./NewJwellaryImages/game-coin.png";
...
const IndiaGoldSecPage = ({ formData, formState, searchParams }) => {
  ...
  const handleSecondPageSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_REACT_APP_BASE_URL}indiagold_Sec_Page`,
        formData1
      );
  ...
  return (
    <>
      {successPage &&
        console.log(
          "After changing the value of successPage is :: ",
          successPage
        )}
      {successPage && <IndiaGoldSuccessPage />}
            ...
            <form ref={formRef} onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleDesiredLoanAmountChange(e.target.value)
                  }
                ...
                <div className={styles.radioGroup}>
                  <label className={styles.radioLabel}>
                    <input
                      ...
                      onChange={(e) =>
                        handleJwellaryLocationChange(e.target.value)
                      }
                      className={styles.radioInput}
                    />
                    At home
...
export default IndiaGoldSecPage;
