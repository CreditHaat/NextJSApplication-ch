...
const NewBlPrimeListPage = ({ companies, getLoanBackendMethod, redirectLinkMethod, mobileNumber, formData }) => {

  const redirectFunction=()=>{
    window.location.href = `https://app.credithaat.com/embedded_journey?mobilenumber=${formData.mobileNumber}`
  }
...
export default NewBlPrimeListPage;