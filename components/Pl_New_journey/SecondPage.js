...
import listimage1 from "../NewPlApplyD/newplimages/updatedpl_jounreybannerimage.jpeg";
...
import NewBlListPage from "../NewPlApplyD/NewBlListPage";
...
import NewPlPage2 from "./ThirdPagePl";
import NewPlApplyDS from "./PlApplyDS";
...
const NewPlPage = ({ params, searchParams, prefillMobile,onBack }) => {
  ...
  const [activeContainer, setActiveContainer] = useState("NewPlPage");
  ...
  //   setActiveContainer("FirstPage"); // Switch the active container to 'NewPlPage'
  // };

  const handleBackButton = () => {
  if (onBack) {
    onBack(); // Go back to FirstPage
  } else {
    setActiveContainer("FirstPage"); // fallback (won't work without onBack)
  }
};
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      formData1.append("userPhoneNumber", prefillMobile);
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_REACT_APP_BASE_URL}new_pl_secondPage`,
        formData1
      );
  ...
  return (
    <>
      ...
      {activeContainer === "NewPlPage" && (
        <div className={`${roboto.className} page-container1`}>
          <div className="carousel-background1">
          {/* <div className="carousel-background">
            <EmblaCarousel slides={SLIDES} options={OPTIONS} />
          </div> */}
                      {/* mynew */}
            <div className="topchildrens">
              ...
              <div className="progressBarContainers">
                ...
                <div className="progressBars">
                  <div className="outerCrcileLinesfirst">
                    {" "}
                    <div className="stepNumbersplds">1</div>{" "}
                  </div>
                  <div
                    className="progressBarFills"
                    // style={{ width: `${progress}%` }}
                  ></div>
                  <div className="progressBarHeadings">
                    Personal <br/>Details
                  </div>
                </div>
                {/* first no:2 progress bar */}
                {/* <div className="progressBars">
                  <div className="outerCrcileLine2s">
                    <div className="stepNumber2s">2</div>
                  </div>
                  <div
                    // className="progressBarFill2s"
                    // style={{ width: `${progress}%` }}
                  ></div>
                  <div className="progressBarHeading2s">
                    Work <br/>Details
                  </div>
                </div> */}
                {/* first no:3 progress bar */}
                <div className="progressBarlasts">
                  <div className="outerCrcileLine3s">
                    <div className="stepNumberLasts">2</div>
                  </div>
                  <div className="progressBarHeading2s">
                    Work <br />
                    Details
          ...
          <div
            className="newfirstcard-containerpl"
          ...
          >
            ...
            <form ref={formRef} onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className={`${styles.formGroup} form-group`}>
                ...
                {formErrors.fullname && (
                  <span className="error1">{formErrors.fullname}</span>
                )}
              </div>
              ...
              <div>
                ...
                {/* <div className={`${styles.formGroup} form-group`}>
                  ...
                  {formErrors.mobileNumber && (
                    <span className="error1">{formErrors.mobileNumber}</span>
                  )}
                </div> */}
                ...
                >
                  ...
                  {formErrors.profession && (
                    <span className="error1">{formErrors.profession}</span>
                  )}
                </div>
              </div>
              ...
              >
                ...
                {formErrors.paymentType && (
                  <span className="error1">{formErrors.paymentType}</span>
                )}
              </div>
              ...
              <div className={`${styles.formGroup} form-group`}>
                ...
                {formErrors.monthlyIncome && (
                  <span className="error1">{formErrors.monthlyIncome}</span>
                )}
              </div>
              ...
              <div className={`${styles.formGroup} form-group`}>
                ...
                {formErrors.pan && (
                  <span className="error1">{formErrors.pan}</span>
                )}
              </div>
