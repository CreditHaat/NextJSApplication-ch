...
import RejectionPageNavbar from './RejectionPageNavbar'
import RejectionPageFooter from "./RejectionPageFooter";
import Image from "next/image";
import faqimage1 from './Rejectionpageimages/rejectionimage.png';
import rejmoneyviewimage from './Rejectionpageimages/rejmoneyviewimage.png';
import rejzypeimage from './Rejectionpageimages/rejzypeimage.png';
import rejhdfclogo from './Rejectionpageimages/rejhdfclogo.png';
import rejsection4image from './Rejectionpageimages/rejsection4image.png';
import anqlogo from './Rejectionpageimages/anqlogo.png';
import walletimg from './Rejectionpageimages/walletimg.png';
import walletimg2 from './Rejectionpageimages/walletimg2.png';
import walletimg3 from './Rejectionpageimages/walletimg3.png';
import rejectionimage2 from './Rejectionpageimages/rejimagenew.png';
import boatlogo from './Rejectionpageimages/boatlogo.png';
import boatimage from './Rejectionpageimages/boatimage.png';
...
function RejectionPage({ lenderName, lender_id }) {
  ...
  return (
    <>
      ...
      <div className="rejectionclasspage">
        <div className="rejectionflexcontainer">
          <div className="rejimagesection">
            <Image
              src={rejectionimage2}
              alt="faqimageone"
              //   width={400}
          ...
          <div className="rejtextsection">
            <h1 className={`text-justify scrollanimation ${isVisible ? 'visible' : ''}`}
              ref={textRef}>Sorry, application <br></br>not accepted</h1>
          </div>
        </div>
      </div>
      <ScrollSpySection>
        <div className="rejsection2" >
          <p>Your loan application was not accepted. Don’t worry we have other lenders that can serve you. Please check other options.</p>
        </div>
      </ScrollSpySection>
      <ScrollSpySection>
      ...
      <ScrollSpySection>
        <div className="rejsection4">
          ...
          <CardSlidePage json={globalResponse} handleAdClick={handleAdClick} />
        </div>
      </ScrollSpySection>
