...
import './BlApplyPrimeMasterFirst.css';
...
import NewBlListPage from "../NewBl_Prime_Master_Journey/NewBlPrimeListPage";
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_REACT_APP_BASE_URL}chfronetendotpgenerator_NewBlPrimeMaster`,
        formData1
      );
...
export default BlApplyPrimeMasterFirst;
