...
const NewPlApplyDS = ({
  ...
  const StoreDataToBackendForSalaried = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_REACT_APP_BASE_URL}PlApplyNew_SelfEmployed`,
        formData1
      );
  ...
  const handleBackButton = () => {
    setActiveContainer("NewPlPage"); // Switch the active container to 'NewPlPage'
  };
            ...
            <div className="topchildrens">
              ...
              <div className="progressBarContainers">
                ...
                <div className="progressBars">
                  <div className="outerCrcileLinesfirstnew">
                    {" "}
                    <div className="stepNumbers">1</div>{" "}
                  </div>
                  <div
