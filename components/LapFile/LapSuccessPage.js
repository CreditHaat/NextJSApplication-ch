  ...
  return (
    <>
      ...
      <div style={{width:"100%", display:"flex", justifyContent:"center", fontSize:"25px"}}>
        ...
        <p style={{textAlign:"center"}}> Your application for a loan against property has been received. Our team would contact you shortly to take the process forward.</p>
      </div>
    </div>
    </div>
      </>
