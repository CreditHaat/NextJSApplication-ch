...
const BLApplyLenders = ({companies, onGetLoan, lenderProduct, setLenderProduct, formData , getLoanBackendMethod, redirectLinkMethod}) => {
 ...
 const handleDataLayerStage = (stage) => {
  ...
  return(
    ...
    <h2 style={{color:"#3e2780", textAlign:"center", marginTop:"25px"}}>Please select a lender to continue</h2>
            ...
            <div className="card-container" style={{fontFamily:'sans-serif'}}>
              ...
              <div className="action-button">
                 ...
                 {lender.cpi === 1 ? (
                                        ...
                                        <button style={{backgroundColor: "#fdc638", color:"#3e2780",border:"none"}} onClick={()=>redirectLinkMethod(lender.applicationlink)}
                                            size="small"
                                            variant="contained"
