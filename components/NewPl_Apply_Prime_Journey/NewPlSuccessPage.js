...
function NewPlSuccessPage({product}) {
  ...
  return (
    <>
      ...
      <div className="newplnewfirstcard-container">
      <div className="newpltext1">
      <div style={{width:"100%", display:"flex", justifyContent:"center", fontSize:"25px"}}>
          Thank You!
        </div>
        <p style={{textAlign:"center"}}>Your application for a {product} has been received. Our team would contact you shortly to take the process forward.</p>
      </div>
    </div>
    </div>
      </>
...
export default NewPlSuccessPage;