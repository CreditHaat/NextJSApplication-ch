...
const NewBlFirstPage = () => {
  ...
  const handleDataSubmit = async (e) => {
    ...
    function handleDataLayerStart(
      ...
      PaymentType,
      businessTurnover,
      availableBusinessDocuments,
      businessAge,
      businessType
    ) {
      console.log(
        "INside handledatalayer , ",
        flag,
        mobile_number,
        emptype,
        PaymentType,
      ...
      window.dataLayer.push({
        ...
        availableBusinessDocuments: availableBusinessDocuments,
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_REACT_APP_BASE_URL}newbljourneyd`,
        formData
      );
  ...
  const redirectLinkMethod = (lenderProduct, applicationLink, productId) => {
    ...
    console.log(
      "Getting the link from the localStorage : ",
      localStorage.getItem("applicationLink")
    );
          ...
          >
            <form ref={formRef} onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className={styles.formGroup}>
                ...
                {errors.turnover && (
                  <p style={{ color: "red" }}>{errors.turnover}</p>
                )}
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                {errors.businessAge && (
                  <p style={{ color: "red" }}>{errors.businessAge}</p>
                )}
              </div>
