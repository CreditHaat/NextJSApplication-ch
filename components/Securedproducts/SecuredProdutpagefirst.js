...
import NewBlListPage from "./SecuredProductListPage";
...
import NewPlPage2 from "./SecuredProductpagesecond";
...
const SecuredProductpagefirst = ({ params, searchParams }) => {
...
// console.log("queryparam is:", queryParams);
// console.log("param is:", params);
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_REACT_APP_BASE_URL}SecuredProductfirstpage`,
        formData1
      );
...
const handleProfessionChange = (selectedOption) => {
  ...
  activeContainer === "newplfirstpage" && (
    <div className={`${roboto.className} page-container`}>
      <div className="securedproductcarousel-background">
        <EmblaCarousel slides={SLIDES} options={OPTIONS} />
      </div>
      <div className="securedproductfirstcard-container" style={{ boxSizing: 'content-box' }}>
...
export default SecuredProductpagefirst;
