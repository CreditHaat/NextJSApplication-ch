...
import './SecuredProductListPage.css';
...
const SecuredProductListPage = ({ companies, getLoanBackendMethod, redirectLinkMethod, mobileNumber }) => {
  ...
  return (
    ...
    {
        (companies!==null)?(<>
        {/* {console.log("Lender Details :: ",companies.lender_details)} */}
        </>):(<></>)
                ...
                companies.lender_details.map((lender, index) => (
                  <div key={index} className="newcard-container">
                    ...
                    <div className="subcardheader">
                      <p className="card-subtitle">{lender.producttype}</p>
                    </div>
                    <div className="card-body">
                      <h1 className="amount"> {lender.maxloanamount}</h1>
                    ...
                    <div>
                      {/* { console.log("In NewBLListPage lender cpi is :: ",lender.cpi)} */}
                      {
                        ...
                        lender.cpi===1?(
                          ...
                          <button className="card-button" onClick={(e)=>getLoanBackendMethod(e,lender.product,lender.product_id)}>Get Loan</button>
                        )
                      }
...
export default SecuredProductListPage;